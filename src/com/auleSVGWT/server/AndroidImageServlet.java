...
public class AndroidImageServlet extends HttpServlet {
        ...
        if(fileExistance){
            try {
                ...
                if("1".equals(mod)){
                    ...
                    occupyDTOs = getOccupy(build,floor);

                    //System.out.println(build +" ......"+floor);


                    if("2".equals(mod)){
                        modalityTwoNew(room, occupyDTOs, doc, out, transcoder);
                        //modalityTwo(room,roomPeopleDTOs,doc,out,transcoder);
                    }
                    else if("3".equals(mod)){

                        modalityThreeNew(room, occupyDTOs, doc, out, transcoder);
    ...
    public ArrayList<OccupyDTO> getOccupy(String building, String floorSt){
    ...
    public void modalityTwoNew(ArrayList<String> strings, ArrayList<OccupyDTO> occupyDTOs,Document doc,OutputStream out,PNGTranscoder transcoder){
    ...
    public void modalityThreeNew(ArrayList<String> strings, ArrayList<OccupyDTO> occupyDTOs,Document doc,OutputStream out,PNGTranscoder transcoder){
